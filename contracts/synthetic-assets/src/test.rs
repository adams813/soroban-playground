...
use crate::{types::*, SyntheticAssetsContract, SyntheticAssetsContractClient};

fn setup_env() -> (
    Env,
    SyntheticAssetsContractClient<'static>,
    Address,
    Address,
    Address,
) {
...
fn mint_collateral_tokens(env: &Env, collateral_token: &Address, to: &Address, amount: i128) {
